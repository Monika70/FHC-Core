...
<?php if($jqueryV1) : ?>
	<script type="text/javascript" src="<?php echo base_url('vendor/jquery/jquery-v1/jquery-1.12.4.min.js'); ?>"></script>
	<script type="text/javascript" src="<?php echo base_url('vendor/christianbach/tablesorter/jquery.tablesorter.min.js'); ?>"></script>
<?php endif ?>

<?php if($jqueryV2) : ?>
	<script type="text/javascript" src="<?php echo base_url('vendor/jquery/jquery-v2/jquery-2.2.4.min.js'); ?>"></script>
<?php endif ?>
